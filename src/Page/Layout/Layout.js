...
const Layout = () => {
  ...
  return (
    <div className="bg-black h-screen flex text-white justify-center items-end">
      <div className=" w-full h-[94%] rounded-2xl border-l-purple-300 bg-[#fff] m-5 relative">
        <div className="Header flex justify-between">
          <div className=" w-[420px] mb-10 h-[87px] bg-[#000] rounded-ee-2xl flex items-center justify-start">
            <div className="w-[420px] h-[80px] bg-[#000000] mr-2 mb-2 rounded-ee-[10px] rounded-ss-[10px] flex justify-center ">
          ...
          <div className=" w-[420px] mb-10 h-[87px] bg-[#000] rounded-es-2xl flex items-center justify-center ">
      ...
      <div className=" w-[420px] mb-10 h-[87px] bg-[#222327] rounded-3xl flex items-center justify-center fixed">
